...
public class LicenseChecker implements ServiceConnection {
     ...
     * @param packageName the package name to check a license for
     * @param encodedPublicKey Base64-encoded RSA public key
     * @throws IllegalArgumentException if encodedPublicKey is invalid
     */
    public LicenseChecker(Context context, Policy policy, String packageName, String encodedPublicKey) {
        mContext = context;
        mPolicy = policy;
