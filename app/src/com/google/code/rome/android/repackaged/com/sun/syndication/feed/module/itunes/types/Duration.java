 ...
 */
package com.google.code.rome.android.repackaged.com.sun.syndication.feed.module.itunes.types;

import com.google.code.rome.android.repackaged.com.sun.syndication.io.impl.NumberParser;
    ...
    public Duration( final String duration ){
        ...
        switch (tok.countTokens() ){
            ...
            case 3:
                ...
                break;
            default:
                this.setMilliseconds(0); // ignore invalid formats
        }
    }
